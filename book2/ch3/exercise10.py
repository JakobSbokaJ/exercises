...
#sorted list part
print(f"Here is the list of sorted guests: {sorted(gList)}")
gList.reverse()
print(f"Here is the list of reverse sorted guests: {gList}")
gList.reverse()
print(f"Here's the original list again: {gList}")
gList.sort()
print(f"Finally, here's the permanently sorted list: {gList}")